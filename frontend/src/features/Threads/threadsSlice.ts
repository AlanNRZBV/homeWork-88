...
export const threadsSlice = createSlice({
  ...
  reducers:{},extraReducers:builder => {
    ...
    builder.addCase(fetchSingleThread.fulfilled,(state,{payload:thread})=>{
...
export const singleThreadState = (state: RootState)=>state.threads.singleThread
export const isThreadsLoading = (state: RootState)=> state.threads.isLoading
export const isSingleThreadLoading = (state: RootState)=> state.threads.isSingleThreadLoading